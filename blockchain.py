...
class Blockchain(object):
    ...
    def new_block(self, proof, previous_hash=None):
        #Creates new block and adds to chain pass
        """
    ...
    def new_transaction(self, sender, recipient, amount):
        #Adds a new transaction to transaction pass
        """
    ...
    def resolve_conflicts(self):
        ...
        # We're only looking for chains longer than it
    ...
    def hash(block):
        ...
        :return: <str>
        """
        # Dictionary must be ordered otherwise inconsistent hashes
